...
function LoginChoiceButton({ icon, label, onClick, accent = "google" }: LoginChoiceButtonProps) {
  // Different gradient colors based on provider
    ...
    <StackClientWrapper>
      <div className="flex justify-center items-center min-h-screen w-full bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="w-full max-w-md px-4">
          ...
          className="flex flex-col w-full p-8 space-y-6 bg-white rounded-2xl shadow-xl border border-slate-200"
        >
          <motion.h1 
          ...
          >
            ...
            <Link className="text-emerald-600 font-medium underline hover:text-emerald-700 transition-colors" href="/sign-up">
              Sign up
            </Link>
          </motion.p>
          ...
          >
            ...
            >
              <Label htmlFor="email" className="text-base text-slate-700 font-medium">
                Email
              </Label>
              <Input 
                type="email"
                ...
                required 
                disabled={loading}
                className="text-base border-2 border-slate-200 focus:border-emerald-500 focus:ring-emerald-500 transition-all" 
              />
            </motion.div>
            <motion.div 
              className="space-y-2"
            ...
            >
              <div className="flex justify-between items-center">
                <Label htmlFor="password" className="text-base text-slate-700 font-medium">
                  Password
                </Label>
                <Link className="text-sm text-emerald-600 underline hover:text-emerald-700 transition-colors" href="/forgot-password">
                  Forgot Password?
                </Link>
              </div>
              <Input
            ...
            >
              <Button 
                type="submit"
                disabled={loading}
                className="w-full text-base shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white"
              >
